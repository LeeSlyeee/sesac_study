...
# df3['비고'] = ['특별시', '광역시', '특례시', '특례시'] # 생성된 DataFrame (df3)에 '비고'라는 이름의 "새로운 열(Column)을 추가"합니다.
...
# del df3['2005-2015 증가율'] # Python의 내장 명령어인 del을 사용하여, 방금 생성한 '2005-2015 증가율' 열(Column)을 DataFrame에서 삭제합니다.
...
# print(df3['지역']) # DataFrame df3에서 "대괄호([ ])"를 사용하여 '지역'이라는 열(Column)을 선택하고 그 내용을 출력합니다.
#                   # 이는 "pandas Series" 객체로 반환됩니다.
# print(type(df3['지역'])) # df3['지역']의 "타입"을 출력합니다.
#                         # 단일 열을 선택했으므로 "pandas.core.series.Series" 타입이 출력됩니다.



# print(df3.지역) # df3 DataFrame에서 "'지역'이라는 이름의 열(Column)을 선택"하여 출력합니다.
